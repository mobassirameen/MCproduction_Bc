...
GEN_REL="CMSSW_10_6_18"
GEN_SCRAM="slc7_amd64_gcc700"
RECO_REL="CMSSW_10_6_18"
RECO_SCRAM="slc7_amd64_gcc700"
MINI_REL="CMSSW_10_6_18"
...
cmsRun -j ${CHANNEL_DECAY}_step0.log -p step0-GS_BcToBsPi_Pythia8_13TeV_TuneCP5_GEN.py
...
echo "================= PB: CMSRUN starting Digi step 1 ===================="
cmsRun -e -j ${CHANNEL_DECAY}_step1.log step1-DR_BcToBsPi_Pythia8_13TeV_TuneCP5_DIGI.py
#cleaning
#rm -rfv step0-GS_BuJpsiK_Pythia8_8p16TeV_TuneCUETP8M1_GEN.root

echo "================= PB: CMSRUN starting Reco step 2 ===================="
cmsRun -e -j ${CHANNEL_DECAY}_step2.log step2-DR_BcToBsPi_Pythia8_13TeV_TuneCP5_RECO.py
